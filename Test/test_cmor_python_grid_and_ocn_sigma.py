...
class TestCase(base_test_cmor_python.BaseCmorTest):
    ...
    def gen_irreg_grid(self, lon, lat):
        lon0 = 5.
        lat0 = -17.5
        delta_lon = .1
        delta_lat = .1
    ...
    def testGridAndOCNSigma(self):
        try:
            ...
            x, y, lon_coords, lat_coords, lon_vertices, lat_vertices = self.gen_irreg_grid(
                lon, lat)
            ...
            Time[0], bnds_time[0:2] = self.read_time(0)
            Time[1], bnds_time[2:4] = self.read_time(1)
