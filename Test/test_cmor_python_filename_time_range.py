...
class TestCase(base_test_cmor_python.BaseCmorTest):
    ...
    def test_decadal(self):
        try:
            table = os.path.join(self.tabledir, 'CMIP6_Odec.json')
    ...
    def test_yr(self):
        try:
            table = os.path.join(self.tabledir, 'CMIP6_Eyr.json')
            cmor.load_table(table)
            axes = [
                {'table_entry': 'time',
                'units': 'days since 2000-01-01 00:00:00',
    ...
    def test_monclim(self):
        try:
            table = os.path.join(self.tabledir, 'CMIP6_Oclim.json')
            cmor.load_table(table)
            axes = [
                {'table_entry': 'time2',
                'units': 'days since 2000-01-01 00:00:00',
    ...
    def test_day(self):
        try:
            table = os.path.join(self.tabledir, 'CMIP6_Eday.json')
            cmor.load_table(table)
            axes = [
                {'table_entry': 'time',
    ...
    def test_6hr(self):
        try:
            table = os.path.join(self.tabledir, 'CMIP6_6hrLev.json')
            cmor.load_table(table)
            axes = [
                {'table_entry': 'time1',
                'units': 'hours since 2000-01-01 00:00:00',
    ...
    def test_3hr(self):
        try:
            table = os.path.join(self.tabledir, 'CMIP6_3hr.json')
            cmor.load_table(table)
            axes = [
                {'table_entry': 'time1',
                'units': 'hours since 2000-01-01 00:00:00',
    ...
    def test_1hr(self):
        try:
            table = os.path.join(self.tabledir, 'CMIP6_E1hr.json')
            cmor.load_table(table)
            axes = [
                {'table_entry': 'time1',
    ...
    def test_1hrclimmon(self):
        try:
            table = os.path.join(self.tabledir, 'CMIP6_E1hrClimMon.json')
            cmor.load_table(table)
            axes = [
                {'table_entry': 'time3',
                'units': 'minutes since 2000-01-01 00:00:00',
    ...
    def test_subhr(self):
        try:
            table = os.path.join(self.tabledir, 'CMIP6_Esubhr.json')
            cmor.load_table(table)
            axes = [
                {'table_entry': 'time1',
    ...
    def test_fx(self):
        try:
            table = os.path.join(self.tabledir, 'CMIP6_fx.json')
            cmor.load_table(table)
            axes = [
                {'table_entry': 'latitude',
                'units': 'degrees_north',
