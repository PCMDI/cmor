...
int cmor_dataset_cff_( char *outpath,
		       ...
		       char *institute_id,
		       char *parent_exp_id,
		       double *branch_time, char *parent_exp_rip ) {
    return cmor_dataset( outpath, experiment_id, institution, source,
			 calendar, *realization, contact, history, comment,
			 references, *leap_year, *leap_month,
			 month_lengths, model_name, forcing,
			 *initialization_method, *physics_version,
			 institute_id, parent_exp_id, branch_time,
			 parent_exp_rip );
}
int cmor_dataset_cff_null_( char *outpath,
    ...
    return cmor_dataset( outpath, experiment_id, institution, source,
			 calendar, *realization, contact, history, comment,
			 references, *leap_year, *leap_month, NULL,
			 model_name, forcing, *initialization_method,
			 *physics_version, institute_id, parent_exp_id,
			 branch_time, parent_exp_rip );
}

/************************************************************************/
/*                      cmor_dataset_cff_nobrch_()                      */
/************************************************************************/
...
int cmor_dataset_cff_nobrch_( char *outpath,
			      ...
			      int *physics_version,
			      char *institute_id,
			      char *parent_exp_id, char *parent_exp_rip ) {
    return cmor_dataset( outpath, experiment_id, institution, source,
			 calendar, *realization, contact, history, comment,
			 references, *leap_year, *leap_month,
			 month_lengths, model_name, forcing,
			 *initialization_method, *physics_version,
			 institute_id, parent_exp_id, NULL,
			 parent_exp_rip );
}

/************************************************************************/
/*                   cmor_dataset_cff_null_nobrch_()                    */
/************************************************************************/
