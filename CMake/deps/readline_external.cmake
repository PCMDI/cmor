...
set(readline_install "${cmor_EXTERNALS}")
...
ExternalProject_Add(readline
  ...
  BUILD_IN_SOURCE 1
  PATCH_COMMAND ${CMAKE_COMMAND} -E copy_if_different ${cmor_external_patch_dir}/src/readline/shobj-conf ${readline_source}/support/shobj-conf
  CONFIGURE_COMMAND ${CMAKE_COMMAND} -DCONFIGURE_ARGS=${readline_conf_args} -DINSTALL_DIR=<INSTALL_DIR> -DWORKING_DIR=<SOURCE_DIR> -P ${cmor_CMAKE_BINARY_DIR}/cmor_configure_step.cmake
