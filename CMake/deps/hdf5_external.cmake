...
set(HDF5_install "${cmor_EXTERNALS}")

configure_file(${cmor_CMAKE_SOURCE_DIR}/cmor_modules_extra/hdf5_patch_step.cmake.in
  ${cmor_CMAKE_BINARY_DIR}/hdf5_patch_step.cmake
  @ONLY)
...
ExternalProject_Add(HDF5
  ...
  URL_MD5 ${HDF5_MD5}
  BUILD_IN_SOURCE 1
  #PATCH_COMMAND ${CMAKE_COMMAND} -DWORKING_DIR=<SOURCE_DIR> -P ${cmor_CMAKE_BINARY_DIR}/hdf5_patch_step.cmake
  CONFIGURE_COMMAND ${CMAKE_COMMAND} -DCONFIGURE_ARGS=${hdf5_configure_args} -DADDITIONAL_CFLAGS=${hdf5_additional_cflags} -DADDITIONAL_CPPFPAGS=-w -DINSTALL_DIR=<INSTALL_DIR> -DWORKING_DIR=<SOURCE_DIR> -P ${cmor_CMAKE_BINARY_DIR}/${configure_file}
