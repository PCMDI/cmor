...
if(WIN32)
  ...
  set(zlib_install "${cmor_EXTERNALS}")
  ...
  ExternalProject_Add(zlib
    ...
    PATCH_COMMAND ${CMAKE_COMMAND} -E remove <SOURCE_DIR>/zconf.h
    BUILD_IN_SOURCE 1
    CONFIGURE_COMMAND ${CMAKE_COMMAND} -DCONFIGURE_ARGS=${CONFIGURE_ARGS} -DINSTALL_DIR=<INSTALL_DIR> -DWORKING_DIR=<SOURCE_DIR> -P ${cmor_CMAKE_BINARY_DIR}/cleanenv_configure_step.cmake
    DEPENDS ${zlib_deps}
    ${ep_log_options}
  )
