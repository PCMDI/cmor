...
add_cmor_package(Python ${PYTHON_MAJOR_SRC}.${PYTHON_MINOR_SRC}.${PYTHON_PATCH_SRC} "" "")

# FIXME: Name style
set(CMOR_OS_XTRA_PATH "")
...
if (CMOR_USE_SYSTEM_PYTHON)
   ...
   if(APPLE)
     set(CMOR_OS_XTRA_PATH ${CMAKE_INSTALL_PREFIX}/Library/Frameworks/Python.framework/Versions/${PYVER}/bin)
   endif()
else ()
